...
if __name__ == "__main__":
    ...
    tex_toroid = createToroidNode(phongTexPipeline, f"{IMG_PATH}/tex.jpg", 0,0,0.2 , 0.5)
    tex_toroid2 = createToroidNode(phongTexPipeline, f"{IMG_PATH}/tex2.jpg", 0,0,-0.6, -0.2)
