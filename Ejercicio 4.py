...
class SimpleNewTextureTransformShaderProgram:
    ...
    def __init__(self):
        ...
        vertex_shader = """
            ...
            uniform mat4 rain_transform;
            uniform float texture_index;
            uniform float rain_index;
...
######################################################################################################
    ...
    gpuRain.texture = es.textureSimpleSetup(
        spritePath, GL_REPEAT, GL_REPEAT, GL_LINEAR, GL_LINEAR)
...
##############################################################################################################
        ...
        glUniformMatrix4fv(glGetUniformLocation(pipeline.shaderProgram, "rain_transform"), 1, GL_TRUE, tr.uniformScale(1))
