...
class Player():
    ...
    def __init__(self, size):
        self.pos = [0,-0.8] # Posicion en el escenario
    ...
    def update(self, delta):
        ...
        # Si detecta la tecla [D] presionada y no se ha salido de la pista se mueve hacia la derecha
        ...
        self.model.transform = tr.matmul([tr.translate(self.pos[0], -0.8, 0), tr.scale(self.size, self.size, 1)])
    ...
    def collision(self, cargas):
        ...
        for carga in cargas:
            ...
            if (self.radio+carga.radio)**2 > ((self.pos[0]-carga.move[0])**2 + (-0.8-carga.move[1])**2):
                print("CHOQUE")
                return
